...
comm -23 <(ls -1 /users/nfairfie/scratch/fil/Skynet*.fil | xargs -L 1 basename | sed 's/_0001\.fil//' | sort) <(ls -1 /users/nfairfie/scratch/results_ft | xargs -L 1 basename | grep Skynet | sort)
